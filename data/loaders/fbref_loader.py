"""
FBref data loader using soccerdata.
Handles network failures gracefully and caches results with st.cache_data.
"""
...
def _get_fbref_client(league: str, season: str):
    ...
    try:
        ...
        st.warning("soccerdata n'est pas installé. Installez-le avec `pip install soccerdata`.")
        return None
